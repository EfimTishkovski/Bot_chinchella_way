...
citate_mass = ['Я скала! Я кремень!',
               'Муррррр...©Кот',
               'Чужая душа - потёмки, но иногда нужно сделать этот шаг в темноту.',
               ...
               'Отступление ещё не бегство. Отход, перегруппировка и новый удар.',
               'Цой Жив!',
               ...
               'Будь твёрд и спокоен как просроченный пряник.',
               ...
               'Если вы разговариваете с вещами это не проблема, проблема - это когда они начинают отвечать',
               'Любая сила безлика, что она будет нести зависит то того кто её использует.',
               'Bella! horida bella!',
               'Легко быть храбрым сидя на диване',
               'Иногда чудеса случаются сами, но чаще всего их приходится организовывать.',
               'Плохой человек долго над бездной не провисит.',
               'Хватит на жопе сидеть, пора дело делать.',
               'Нельзя из букв Ж П О А сложить слово вечность',
               'А моря наполнялись по каплям, и сраслись по песчинкам камни, вечность это ,наверное, так долго. ©Flür'
]
print('Запущено')
